...
<body>
	...
	textfield, select, checbox y checckboxlist
	
	vamos a usar una entidad Etiquetas, que tiene una lista de paises para mostrar los controles.
	...
	<s:form action="mostrarEtiquetas" >
		...
		<s:set name="serverList" value="#{'AppServer': {'Apache', 'Tomcat', 'JBoss'}, 'Database': {'Oracle', 'MySQL'}, 'lenguaje': {'Java', 'PHP'}, 'otros': {'visual','C.++'} }" />
